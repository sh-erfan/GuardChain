...
{
    public class AgainstDefaultTestsForFloat
    {
        ...
        public void DoesNothingGivenNonDefaultValue()
        {
            ...
            Guard.Protect(data.FloatInputWithValue1).Against.Default();
        }
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Guard.Protect(data.FloatInputWithValue1).Against.Default<MyCustomException>();
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Assert.Equal(data.FloatInputWithValue1, Guard.Protect(data.FloatInputWithValue1).Against.Default<MyCustomException>().Input);
        }
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Assert.Equal(nameof(data.FloatInputWithValue1), Guard.Protect(data.FloatInputWithValue1, nameof(data.FloatInputWithValue1)).Against.Default<MyCustomException>().InputParameterName);
        }
        ...
        public void ThrowsCustomExceptionGivenDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.FloatInputWithDefaultValue).Against.Default<MyCustomException>());
        }
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Guard.Protect(data.FloatInputWithValue1).Against.Default<MyCustomException>("args1");
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Assert.Equal(data.FloatInputWithValue1, Guard.Protect(data.FloatInputWithValue1).Against.Default<MyCustomException>("args1").Input);
        }
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Assert.Equal(nameof(data.FloatInputWithValue1), Guard.Protect(data.FloatInputWithValue1, nameof(data.FloatInputWithValue1)).Against.Default<MyCustomException>("args1").InputParameterName);
        }
        ...
        public void ThrowsCustomExceptionGivenDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.FloatInputWithDefaultValue).Against.Default<MyCustomException>("args1"));
        }
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Guard.Protect(data.FloatInputWithValue1).Against.Default(typeof(MyCustomException));
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Assert.Equal(data.FloatInputWithValue1, Guard.Protect(data.FloatInputWithValue1).Against.Default(typeof(MyCustomException)).Input);
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Assert.Equal(nameof(data.FloatInputWithValue1), Guard.Protect(data.FloatInputWithValue1, nameof(data.FloatInputWithValue1)).Against.Default(typeof(MyCustomException)).InputParameterName);
        ...
        public void ThrowsCustomExceptionGivenDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.FloatInputWithDefaultValue).Against.Default(typeof(MyCustomException)));
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Guard.Protect(data.FloatInputWithValue1).Against.Default(typeof(MyCustomException), "args1");
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Assert.Equal(data.FloatInputWithValue1, Guard.Protect(data.FloatInputWithValue1).Against.Default(typeof(MyCustomException), "args1").Input);
        }
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Assert.Equal(nameof(data.FloatInputWithValue1), Guard.Protect(data.FloatInputWithValue1, nameof(data.FloatInputWithValue1)).Against.Default(typeof(MyCustomException), "args1").InputParameterName);
        }
        ...
        public void ThrowsCustomExceptionGivenValueEqualToLimitWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.FloatInputWithDefaultValue).Against.Default(typeof(MyCustomException), "args1"));
        }
