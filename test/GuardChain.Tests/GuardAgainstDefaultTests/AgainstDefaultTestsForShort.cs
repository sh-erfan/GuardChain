...
{
    public class AgainstDefaultTestsForShort
    {
        ...
        public void DoesNothingGivenNonDefaultValue()
        {
            ...
            Guard.Protect(data.ShortInputWithValue1).Against.Default();
        }
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Guard.Protect(data.ShortInputWithValue1).Against.Default<MyCustomException>();
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Assert.Equal(data.ShortInputWithValue1, Guard.Protect(data.ShortInputWithValue1).Against.Default<MyCustomException>().Input);
        }
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Assert.Equal(nameof(data.ShortInputWithValue1), Guard.Protect(data.ShortInputWithValue1, nameof(data.ShortInputWithValue1)).Against.Default<MyCustomException>().InputParameterName);
        }
        ...
        public void ThrowsCustomExceptionGivenDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.ShortInputWithDefaultValue).Against.Default<MyCustomException>());
        }
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Guard.Protect(data.ShortInputWithValue1).Against.Default<MyCustomException>("args1");
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Assert.Equal(data.ShortInputWithValue1, Guard.Protect(data.ShortInputWithValue1).Against.Default<MyCustomException>("args1").Input);
        }
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Assert.Equal(nameof(data.ShortInputWithValue1), Guard.Protect(data.ShortInputWithValue1, nameof(data.ShortInputWithValue1)).Against.Default<MyCustomException>("args1").InputParameterName);
        }
        ...
        public void ThrowsCustomExceptionGivenDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.ShortInputWithDefaultValue).Against.Default<MyCustomException>("args1"));
        }
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Guard.Protect(data.ShortInputWithValue1).Against.Default(typeof(MyCustomException));
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Assert.Equal(data.ShortInputWithValue1, Guard.Protect(data.ShortInputWithValue1).Against.Default(typeof(MyCustomException)).Input);
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Assert.Equal(nameof(data.ShortInputWithValue1), Guard.Protect(data.ShortInputWithValue1, nameof(data.ShortInputWithValue1)).Against.Default(typeof(MyCustomException)).InputParameterName);
        ...
        public void ThrowsCustomExceptionGivenDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.ShortInputWithDefaultValue).Against.Default(typeof(MyCustomException)));
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Guard.Protect(data.ShortInputWithValue1).Against.Default(typeof(MyCustomException), "args1");
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Assert.Equal(data.ShortInputWithValue1, Guard.Protect(data.ShortInputWithValue1).Against.Default(typeof(MyCustomException), "args1").Input);
        }
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Assert.Equal(nameof(data.ShortInputWithValue1), Guard.Protect(data.ShortInputWithValue1, nameof(data.ShortInputWithValue1)).Against.Default(typeof(MyCustomException), "args1").InputParameterName);
        }
        ...
        public void ThrowsCustomExceptionGivenValueEqualToLimitWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.ShortInputWithDefaultValue).Against.Default(typeof(MyCustomException), "args1"));
        }
