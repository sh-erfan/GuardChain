...
{
    public class AgainstDefaultTestsForInt
    {
        ...
        public void DoesNothingGivenNonDefaultValue()
        {
            ...
            Guard.Protect(data.IntInputWithValue1).Against.Default();
        }
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Guard.Protect(data.IntInputWithValue1).Against.Default<MyCustomException>();
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Assert.Equal(data.IntInputWithValue1, Guard.Protect(data.IntInputWithValue1).Against.Default<MyCustomException>().Input);
        }
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Assert.Equal(nameof(data.IntInputWithValue1), Guard.Protect(data.IntInputWithValue1, nameof(data.IntInputWithValue1)).Against.Default<MyCustomException>().InputParameterName);
        }
        ...
        public void ThrowsCustomExceptionGivenDefaultValueWithCustomExceptionTypeAsTException()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.IntInputWithDefaultValue).Against.Default<MyCustomException>());
        }
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Guard.Protect(data.IntInputWithValue1).Against.Default<MyCustomException>("args1");
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Assert.Equal(data.IntInputWithValue1, Guard.Protect(data.IntInputWithValue1).Against.Default<MyCustomException>("args1").Input);
        }
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Assert.Equal(nameof(data.IntInputWithValue1), Guard.Protect(data.IntInputWithValue1, nameof(data.IntInputWithValue1)).Against.Default<MyCustomException>("args1").InputParameterName);
        }
        ...
        public void ThrowsCustomExceptionGivenDefaultValueWithCustomExceptionTypeAsTExceptionHavingConstructorArguments()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.IntInputWithDefaultValue).Against.Default<MyCustomException>("args1"));
        }
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Guard.Protect(data.IntInputWithValue1).Against.Default(typeof(MyCustomException));
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Assert.Equal(data.IntInputWithValue1, Guard.Protect(data.IntInputWithValue1).Against.Default(typeof(MyCustomException)).Input);
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Assert.Equal(nameof(data.IntInputWithValue1), Guard.Protect(data.IntInputWithValue1, nameof(data.IntInputWithValue1)).Against.Default(typeof(MyCustomException)).InputParameterName);
        ...
        public void ThrowsCustomExceptionGivenDefaultValueWithCustomExceptionTypeAsParameter()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.IntInputWithDefaultValue).Against.Default(typeof(MyCustomException)));
        ...
        public void DoesNothingGivenNonDefaultValueWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Guard.Protect(data.IntInputWithValue1).Against.Default(typeof(MyCustomException), "args1");
        }
        ...
        public void PreservesInputGivenNonDefaultValueWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Assert.Equal(data.IntInputWithValue1, Guard.Protect(data.IntInputWithValue1).Against.Default(typeof(MyCustomException), "args1").Input);
        }
        ...
        public void PreservesInputParameterNameGivenNonDefaultValueWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Assert.Equal(nameof(data.IntInputWithValue1), Guard.Protect(data.IntInputWithValue1, nameof(data.IntInputWithValue1)).Against.Default(typeof(MyCustomException), "args1").InputParameterName);
        }
        ...
        public void ThrowsCustomExceptionGivenValueEqualToLimitWithCustomExceptionTypeAsParameterHavingConstructorArguments()
        {
            ...
            Assert.Throws<MyCustomException>(() => Guard.Protect(data.IntInputWithDefaultValue).Against.Default(typeof(MyCustomException), "args1"));
        }
